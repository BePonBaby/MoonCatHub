...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://110801179250945",
...
local v15 = v14:CreateWindow({
    Title = "MoonCat Hub  Hub",
    SubTitle = "by Bé Pon Baby",
    TabWidth = 160,
    Theme = "Dark",
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=110801179250945";
v24.Parent = v23;
